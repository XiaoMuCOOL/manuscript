/************************************************************************************************
 *本日历是Eric推荐给阿龙，阿龙基于tiannet的代码，增加了秒的选择，并修复了一个页面出现多种不同长度时间时存在的
 *小bug---tiannet会选择最长的时间值做为返回值。
 ************************************************************************************************
 ...
 * (4)选择日期、小时分钟及秒钟 <input type="text" name="datehms" readOnly onClick="setDayHMS(this);">
 *设置参数的方法
 ...
 *说明：
 * 默认返回的日期时间格式如同：2005-02-02 08:08:00
 */
//------------------ 样式定义 ---------------------------//
//功能按钮同样样式
