...
var gShowTime=true; //true: show time,false: does not show time
...
var gsNavPrev="<IMG id='navPrev' class='MonthNav' src='images/arrowl.gif' width='18' height='18' border='0' alt='' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the left month navigator
var gsNavNext="<IMG id='navNext' class='MonthNav' src='images/arrowr.gif' width='18' height='18' border='0' alt='' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the right month navigator
